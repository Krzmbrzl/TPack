...
struct OrbitCanonicalCheckTest
...
TEST_P(OrbitCanonicalCheckTest, is_canonical) {
...
// clang-format off
INSTANTIATE_TEST_SUITE_P(
	TPack, OrbitCanonicalCheckTest,
	testing::Values(
		// If there is only a single partition level containing only a single element, indexings are always canonical
		OrbitCanonicalCheckTest::param_tuple({ 4 }, util::make_info_l({ 8 }, { 0 }), true),
		OrbitCanonicalCheckTest::param_tuple({ 7 }, util::make_info_l({ 8 }, { 0 }), true),
		// Inside partition levels, we expect the elements to be non-ascending
		OrbitCanonicalCheckTest::param_tuple({ 0, 0 }, util::make_info_l({ 3, 3 }, { 0, 1 }), true),
		OrbitCanonicalCheckTest::param_tuple({ 1, 0 }, util::make_info_l({ 3, 3 }, { 0, 1 }), true),
		OrbitCanonicalCheckTest::param_tuple({ 0, 1 }, util::make_info_l({ 3, 3 }, { 0, 1 }), false),
		OrbitCanonicalCheckTest::param_tuple({ 1, 0 }, util::make_info_l({ 3, 3 }, { 1, 0 }), false),
		OrbitCanonicalCheckTest::param_tuple({ 0, 1 }, util::make_info_l({ 3, 3 }, { 1, 0 }), true),
		...
		OrbitCanonicalCheckTest::param_tuple({ 0, 0, 0, 0 }, util::make_info_p({ 3, 3 }, { { 0, 1 }, { 2, 3 } }), true),
		OrbitCanonicalCheckTest::param_tuple({ 0, 1, 0, 0 }, util::make_info_p({ 3, 3 }, { { 0, 1 }, { 2, 3 } }), false),
		OrbitCanonicalCheckTest::param_tuple({ 0, 0, 1, 0 }, util::make_info_p({ 3, 3 }, { { 0, 1 }, { 2, 3 } }), true),
		OrbitCanonicalCheckTest::param_tuple({ 0, 0, 0, 1 }, util::make_info_p({ 3, 3 }, { { 0, 1 }, { 2, 3 } }), false),
		OrbitCanonicalCheckTest::param_tuple({ 0, 1, 1, 0 }, util::make_info_p({ 3, 3 }, { { 0, 1 }, { 2, 3 } }), true),
		// In case of multiple partitions, they have to be canonical individually without any defined order between them
		OrbitCanonicalCheckTest::param_tuple({ 1, 0, 0 }, util::make_info({ 3, 3 }, { { { 0, 1 }, { 2 } }, { { 3 } } }), true),
		OrbitCanonicalCheckTest::param_tuple({ 1, 0, 2 }, util::make_info({ 3, 3 }, { { { 0, 1 }, { 2 } }, { { 3 } } }), true),
		OrbitCanonicalCheckTest::param_tuple({ 0, 1, 2 }, util::make_info({ 3, 3 }, { { { 0, 1 }, { 2 } }, { { 3 } } }), false)
	)
);
// clang-format on
